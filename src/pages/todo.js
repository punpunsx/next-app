...
export default function todo() {
    ...
    function doneClicked(index) {
        ...
        let humana = todos.filter((data, todoIndex) => {
            if (index === todoIndex) {
                return data;
            }
        })
            ...
            <div className="grow shrink-0 w-[500px]">
                <div className="pt-5">
                    <div className="text-lg font-bold">Todos
                        <button onClick={() => view()} className="mt-3 mr-4 shadow bg-stone-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                            View
                        </button></div>
